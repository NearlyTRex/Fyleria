...
Setup['steps']['linux'].append('CopyFile("./bin/release/premake5", "../../../premake5")')
Setup['steps']['cygwin'] = []
Setup['steps']['cygwin'].append('RunProcess("make -f Bootstrap.mak linux")')
Setup['steps']['cygwin'].append('MakeExecutable("./bin/release/premake5")')
Setup['steps']['cygwin'].append('CopyFile("./bin/release/premake5", "../../../premake5")')
Setup['steps']['wsl'] = []
Setup['steps']['wsl'].append('RunProcess("make -f Bootstrap.mak linux")')
Setup['steps']['wsl'].append('MakeExecutable("./bin/release/premake5")')
Setup['steps']['wsl'].append('CopyFile("./bin/release/premake5", "../../../premake5")')
Setup['steps']['macosx'] = []
...
Setup['steps']['macosx'].append('CopyFile("./bin/release/premake5", "../../../premake5")')
Setup['steps']['bsd'] = []
Setup['steps']['bsd'].append('RunProcess("make -f Bootstrap.mak bsd")')
Setup['steps']['bsd'].append('MakeExecutable("./bin/release/premake5")')
Setup['steps']['bsd'].append('CopyFile("./bin/release/premake5", "../../../premake5")')
Setup['steps']['mingw'] = []
...
Setup['steps']['mingw'].append('CopyFile("./bin/release/premake5.exe", "../../../premake5.exe")')
Setup['steps']['windows'] = []
...
Setup['steps']['windows'].append('CopyFile("./bin/release/premake5.exe", "../../../premake5.exe")')
