...
#ifndef _GECKO_CHARACTER_CHARACTER_GENERATOR_H_
#define _GECKO_CHARACTER_CHARACTER_GENERATOR_H_
...
public:
    ...
    // Load from file
    Bool LoadFromFile(const String& sFilename, const String& sType);

    // Save to file
    Bool SaveToFile(const String& sFilename, const String& sType);
