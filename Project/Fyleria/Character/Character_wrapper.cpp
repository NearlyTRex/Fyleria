...
PYBIND11_EMBEDDED_MODULE(GeckoCharacter, m)
{
    ...
    PyBindClass<Gecko::Character>(m, "Character")
        ...
        WRAPPING_ADD_METHOD_SIMPLE(GetCharacterID_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetPartyID_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetCharacterTargetType_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetCurrentWeaponSet_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetEquippedItems_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetAvailableActions_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetPassiveChanges_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetActiveChanges_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetActionableChanges_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetProgressDataSegment_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetBattleDataSegment_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetProgressDataBase_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetProgressDataPassives_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetProgressDataActives_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetBattleDataBase_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetBattleDataPassives_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetBattleDataActives_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetBasicData_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetActionData_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetSkillData_MR, Gecko::Character)
        WRAPPING_ADD_METHOD_SIMPLE(GetStatChangeData_MR, Gecko::Character)
    ;
    ...
    PyBindClass<Gecko::CharacterManager>(m, "CharacterManager")
        ...
        WRAPPING_ADD_METHOD_SIMPLE(DoesCharacterExist_MR, Gecko::CharacterManager)
        WRAPPING_ADD_METHOD_SIMPLE(IsValidCharacterID_MR, Gecko::CharacterManager)
        WRAPPING_ADD_METHOD_SIMPLE(GetCharacter_MR, Gecko::CharacterManager)
    ;
