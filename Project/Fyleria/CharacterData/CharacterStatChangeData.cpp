...
void CharacterStatChangeData::UpdateAvailableChanges(const String& sCharacterID)
{
    ...
    GetManagers()->GetSkillManager()->FillSkillStatChangeArrays(
        sCharacterID,
        vSkillPassives,
        vSkillActives,
        vSkillActionables,
    ...
    GetManagers()->GetItemManager()->FillItemStatChangeArrays(
        GetManagers()->GetItemManager()->GetAllEquippedItems(sCharacterID),
        vItemPassives,
        vItemActives,
        vItemActionables);
