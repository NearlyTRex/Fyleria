...
PYBIND11_EMBEDDED_MODULE(GeckoCharacterData, m)
{
    ...
    PyBindClass<Gecko::CharacterStatChangeData>(m, "CharacterStatChangeData")
        ...
        WRAPPING_ADD_METHOD_OVERLOADED_POLICY(GetProlongedStatChange, Gecko::CharacterStatChangeData, PyBindReturnRefInternal, const Gecko::IndexedString&)
        WRAPPING_ADD_METHOD_OVERLOADED_POLICY_CONST(GetProlongedStatChange, Gecko::CharacterStatChangeData, PyBindReturnCopy, const Gecko::IndexedString&)
