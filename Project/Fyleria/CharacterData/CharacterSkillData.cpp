...
{
    // Combat Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BarbarianCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BarbarianRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(MageCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(MageRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RogueCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RogueRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BlademasterCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BlademasterRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AvatarCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AvatarRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AmbidextrousCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AmbidextrousRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FocusedCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FocusedRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StalwartCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StalwartRank, Int, 0);

    // Weapon Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SlashCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SlashRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SeverCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SeverRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SliceCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SliceRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SlitCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SlitRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CleaveCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CleaveRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DecapitateCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DecapitateRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ParryCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ParryRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RiposteCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RiposteRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BashCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BashRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SmashCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SmashRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CrushCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CrushRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ImpactCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ImpactRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BreakCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BreakRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CrackCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CrackRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BlockCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BlockRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RushCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(RushRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PierceCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PierceRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DrillCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DrillRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShootCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShootRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ImpaleCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ImpaleRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StealthStrikeCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StealthStrikeRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CriticalShotCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CriticalShotRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DodgeCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DodgeRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CounterCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(CounterRank, Int, 0);

    // Alchemy Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HealerCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HealerRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AlchemistCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(AlchemistRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(EnergistCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(EnergistRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ChemistCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ChemistRank, Int, 0);

    // Crafting Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HammersmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HammersmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SpellsmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SpellsmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BowsmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BowsmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SwordsmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SwordsmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(WeaverCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(WeaverRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(TannerCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(TannerRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ScalesmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ScalesmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PlatesmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PlatesmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(GoldsmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(GoldsmithRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShieldsmithCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShieldsmithRank, Int, 0);

    // Breakdown Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HammerbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HammerbaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SpellbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SpellbaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BowbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BowbaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SwordbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(SwordbaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ThreadbareCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ThreadbareRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StudRemoverCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(StudRemoverRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ScalebaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ScalebaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PlatebaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(PlatebaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(GoldbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(GoldbaneRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShieldbaneCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShieldbaneRank, Int, 0);

    // Affinity Skills
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HolyCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(HolyRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FireCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FireRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(IceCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(IceRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShockCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ShockRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DarkCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(DarkRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(LightCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(LightRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ForceCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(ForceRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(MindCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(MindRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(EarthCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(EarthRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BloodCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(BloodRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FleshCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(FleshRank, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(WindCurrent, Int, 0);
    SET_OBJ_DATA_FROM_JSON_OR_DEFAULT(WindRank, Int, 0);
}
