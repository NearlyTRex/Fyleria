...
PYBIND11_EMBEDDED_MODULE(GeckoStats, m)
{
    ...
    PyBindClass<Gecko::StatChangeEntry>(m, "StatChangeEntry")
        ...
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(DeltaFloatArray, Gecko::StatChangeEntry)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(DeltaIntArray, Gecko::StatChangeEntry)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(DeltaBoolArray, Gecko::StatChangeEntry)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(DeltaStringArray, Gecko::StatChangeEntry)
