...
namespace Gecko
{
    ...
    public:
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableAirPlay, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableCaptionDisplay, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableIgnoreViewportScalingConstraints, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnablePrintBackgrounds, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableRespectImageOrientation, Bool, false);
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableRestrictHTTPResponseAccess, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableSubtitleDisplay, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableTextDescriptionDisplay, Bool, false);
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableUniversalAccessFromFileUrls, Bool, true);
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableServiceWorkerShortTimeout, Bool, false);
        ...
        MAKE_PRIMITIVE_TYPE_ACCESSORS_INITIAL_VALUE_GET_ONLY(EnableXSSAuditing, Bool, false);
    };
};
