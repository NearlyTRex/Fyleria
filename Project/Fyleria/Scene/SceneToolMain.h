...
#ifndef _GECKO_SCENE_TOOL_MAIN_H_
#define _GECKO_SCENE_TOOL_MAIN_H_
...
class SceneToolMain : public Scene
{
public:
...
// Typedef
MAKE_COMMON_TYPEDEFS(SceneToolMain);
