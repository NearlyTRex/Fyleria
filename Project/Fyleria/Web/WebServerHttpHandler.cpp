...
WebServerHttpHandler::WebServerHttpHandler(const String& sWebRoot)
    : HttpHandler()
{
    SetWebRoot(sWebRoot);
}

void WebServerHttpHandler::onRequest(const HttpRequest& request, HttpResponseWriter response)
{
...
void WebServerHttpHandler::DoOptions_RequestToRun(const HttpRequest& request, HttpResponseWriter& response)
{
    HandleResponse(HttpCodeOk, response, "", "text/plain");
}

void WebServerHttpHandler::DoPost_RunModuleFile(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputFile = "";
...
void WebServerHttpHandler::DoPost_RunModuleFileResults(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputFile = "";
...
void WebServerHttpHandler::DoPost_RunModuleCommand(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
...
void WebServerHttpHandler::DoPost_RunModuleCommandResults(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputCommand = "";
    String sInputResultsId = "";
...
void WebServerHttpHandler::DoPost_SetCurrentModuleResultID(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputResultsId = "";
...
void WebServerHttpHandler::DoPost_ClearModuleResult(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputResultsId = "";
    if(!GetRequiredParameter(request, response, "results_id", sInputResultsId))
...
void WebServerHttpHandler::DoPost_ClearAllModuleResults(const HttpRequest& request, HttpResponseWriter& response)
{
    // Run method
...
void WebServerHttpHandler::DoGet_DoesModuleResultExist(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputResultsId = "";
    if(!GetRequiredParameter(request, response, "results_id", sInputResultsId))
...
void WebServerHttpHandler::DoGet_GetModuleResultSize(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputResultsId = "";
    if(!GetRequiredParameter(request, response, "results_id", sInputResultsId))
...
void WebServerHttpHandler::DoGet_GetModuleResults(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get input
    String sInputResultsId = "";
    if(!GetRequiredParameter(request, response, "results_id", sInputResultsId))
...
void WebServerHttpHandler::DoRequest_ServeTool(const HttpRequest& request, HttpResponseWriter& response)
{
...
void WebServerHttpHandler::DoRequest_ServeFile(const HttpRequest& request, HttpResponseWriter& response)
{
    // Get request resource string
    const String sResource = request.resource();
...
void WebServerHttpHandler::HandleResponse(const HttpCode& code, HttpResponseWriter& response, const String& sResponse, const String& sMimeType)
{
    // Send response
...
Bool WebServerHttpHandler::SendResultsToUser(HttpResponseWriter& response, const String& sResultsID, Bool bKeepResults)
{
    // Get results size
    LOG_STATEMENT("Calling DLL_GetModuleResultSize");
...
Bool WebServerHttpHandler::SendFileToUser(HttpResponseWriter& response, const String& sFile)
{
...
template <class T>
Bool WebServerHttpHandler::GetOptionalParameter(
...
template <class T>
Bool WebServerHttpHandler::GetRequiredParameter(
    const HttpRequest& request,
