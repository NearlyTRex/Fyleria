...
typedef STDMap<String, String> StringStringMap;
typedef STDMap<WString, WString> WStringWStringMap;
typedef STDSet<String> StringSet;
typedef STDSet<WString> WStringSet;
typedef STDUnorderedMap<String, Bool> StringBoolUnorderedMap;
typedef STDUnorderedMap<String, Byte> StringByteUnorderedMap;
typedef STDUnorderedMap<String, Short> StringShortUnorderedMap;
typedef STDUnorderedMap<String, Int> StringIntUnorderedMap;
typedef STDUnorderedMap<String, Float> StringFloatUnorderedMap;
typedef STDUnorderedMap<String, Double> StringDoubleUnorderedMap;
typedef STDUnorderedMap<String, String> StringStringUnorderedMap;
typedef STDUnorderedMap<WString, WString> WStringWStringUnorderedMap;
typedef STDUnorderedMap<String, StringArray> StringStringArrayUnorderedMap;
typedef STDUnorderedSet<Bool> BoolUnorderedSet;
typedef STDUnorderedSet<Short> ShortUnorderedSet;
typedef STDUnorderedSet<Int> IntUnorderedSet;
...
typedef SafeObject<StringArray> SafeStringArray;
typedef SafeObject<WStringArray> SafeWStringArray;
typedef SafeObject<StringStringMap> SafeStringStringMap;
typedef SafeObject<WStringWStringMap> SafeWStringWStringMap;
typedef SafeObject<StringSet> SafeStringSet;
typedef SafeObject<WStringSet> SafeWStringSet;
typedef SafeObject<StringStringUnorderedMap> SafeStringStringUnorderedMap;
typedef SafeObject<WStringWStringUnorderedMap> SafeWStringWStringUnorderedMap;
