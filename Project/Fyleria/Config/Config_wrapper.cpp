...
PYBIND11_EMBEDDED_MODULE(GeckoConfig, m)
{
    ...
    PyBindClass<Gecko::ConfigManager>(m, "ConfigManager")
        ...
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(EnableScrollbars, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(EnableContextMenu, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(StartFullscreen, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_MULTIGET(StartMaximized, Gecko::ConfigManager)
