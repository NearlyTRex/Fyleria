...
PYBIND11_EMBEDDED_MODULE(GeckoConfig, m)
{
    ...
    PyBindClass<Gecko::ConfigManager>(m, "ConfigManager")
        ...
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(PythonLib, Gecko::ConfigManager)
        ...
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(WebFolder, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(WebHostname, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(RestUrl, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(WebsocketUrl, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(EnableScrollbars, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(EnableContextMenu, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(StartFullscreen, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(StartMaximized, Gecko::ConfigManager)
        ...
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(RestPort, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(WebsocketPort, Gecko::ConfigManager)
        WRAPPING_ADD_BASIC_PROPERTY_READONLY_MULTIGET(ServerThreads, Gecko::ConfigManager)
