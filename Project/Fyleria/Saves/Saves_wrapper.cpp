...
PYBIND11_EMBEDDED_MODULE(GeckoSaves, m)
{
    ...
    PyBindClass<Gecko::SaveManager>(m, "SaveManager")
        ...
        WRAPPING_ADD_METHOD_OVERLOADED(CollectSaveData, Gecko::SaveManager, Gecko::UByte, const Gecko::String&)
        WRAPPING_ADD_METHOD_OVERLOADED(CollectSaveData, Gecko::SaveManager, Gecko::UByte, const Gecko::StringArray&, const Gecko::String&, Gecko::ULong)
