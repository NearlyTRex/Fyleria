-- Configuration
libBoost_extradir = "Libs/Cpp/Boost/extra/"
libBoost_origdir = "Libs/Cpp/Boost/orig/"
...
libBoost_sources = {
    ...
    libBoost_srcdir .. "filesystem/src/directory.cpp",
    libBoost_srcdir .. "filesystem/src/exception.cpp",
