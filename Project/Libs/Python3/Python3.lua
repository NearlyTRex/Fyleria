...
libPython3_sources = {
    ...
    libPython3_srcdir .. "Modules/main.c",
    ...
    libPython3_srcdir .. "Objects/call.c",
    ...
    libPython3_srcdir .. "Objects/interpreteridobject.c",
    ...
    libPython3_srcdir .. "Objects/picklebufobject.c",
    ...
    libPython3_srcdir .. "Python/hamt.c",
    libPython3_srcdir .. "Python/import.c",
    libPython3_srcdir .. "Python/initconfig.c",
    ...
    libPython3_srcdir .. "Python/pathconfig.c",
    libPython3_srcdir .. "Python/peephole.c",
    libPython3_srcdir .. "Python/preconfig.c",
