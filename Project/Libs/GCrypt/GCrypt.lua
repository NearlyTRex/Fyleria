...
libGCrypt_sources = {
    ...
    libGCrypt_srcdir .. "cipher/cipher-gcm-armv7-neon.S",
    ...
    libGCrypt_srcdir .. "cipher/cipher-eax.c",
    ...
    libGCrypt_srcdir .. "cipher/chacha20-amd64-ssse3.S",
    libGCrypt_srcdir .. "cipher/chacha20-amd64-avx2.S",
    ...
    libGCrypt_srcdir .. "cipher/ecc-ecdh.c",
    ...
    libGCrypt_srcdir .. "cipher/sha256-intel-shaext.c",
    ...
    libGCrypt_srcdir .. "cipher/blake2b-amd64-avx2.S",
    libGCrypt_srcdir .. "cipher/blake2s-amd64-avx.S",
    ...
    libGCrypt_srcdir .. "cipher/sha1-avx2-bmi2-amd64.S",
    libGCrypt_srcdir .. "cipher/sha1-intel-shaext.c",
    libGCrypt_srcdir .. "cipher/sm3.c",
